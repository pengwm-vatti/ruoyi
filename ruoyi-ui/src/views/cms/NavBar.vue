<template>
  <el-header :style="'margin-bottom:'+ headerBottom +'px'">
    <h2 class="logo"><svg-icon icon-class="EarOfWheat" />  DET</h2>
    <div class="bg-purple-light">
      <el-menu :default-active="activeIndex" router class="el-menu-demo" mode="horizontal" style="border: none;"
        ...
        <el-menu-item index="/cms/main/cmsIndex"><i class="el-icon-s-home" style="color: rgba(255, 255, 255);"></i>销售数据
        </el-menu-item>
        ...
        <el-menu-item @click="onClick">
          <i class="el-icon-chat-dot-round" style="color: rgba(255, 255, 255);"></i>推荐大模型
        </el-menu-item>
    ...
    <div class="bg-purple-light el-menu-hidden" v-if="menuHiddenVisiable">
      <el-menu :default-active="activeIndex" router background-color="rgba(84,92,100,0.5)" text-color="#fff"
        ...
        <el-menu-item index="/cms/main/cmsIndex" @click="menuAway"><i class="el-icon-s-home"
            style="color: rgba(255, 255, 255);"></i>销售数据</el-menu-item>
        <el-menu-item :index="item.path" v-for="item in menulist" :key="item.id" @click="menuAway">
          <!--                图标-->
          <i class="el-icon-document" style="color: rgba(255, 255, 255);"></i>
          <!--                文本-->
          {{item.authName}}
        </el-menu-item>
        <el-menu-item @click="onClick">
  ...
  export default {
    ...
    methods: {
      onClick() {
        ...
        //window.location.href = 'https://6fe09bd9.r11.vip.cpolar.cn/';
