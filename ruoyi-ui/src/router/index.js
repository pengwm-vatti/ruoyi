    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: 'message',
            component: (resolve) => require(['@/views/cms/components/chatAnalysisData/chatAnalysisData'], resolve),
            name: 'message',
            meta: {
              title: '推荐大模型',
            }
          ...
          {
            path: 'doucument',
            component: (resolve) => require(['@/views/cms/components/fusionAnalysisData/cmsDoucument'], resolve),
            hidden: true,
            name: '融合分析数据',
          }
        ]
