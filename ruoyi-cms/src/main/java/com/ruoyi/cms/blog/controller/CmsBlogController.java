...
public class CmsBlogController extends BaseController
{
    ...
    @Autowired
    private ICmsSaleDataService cmsSaleDataService;


    /**
     * 查询销量top10商品
     */
    @GetMapping("/cms/cmsSaleDataTopList")
    public AjaxResult cmsList(CmsSaleDataSummary cmsSaleDataSummary)
    {
        AjaxResult ajax = AjaxResult.success();
        List<CmsSaleDataSummary> list = cmsSaleDataService.selectSaleDataTOP(cmsSaleDataSummary);
        ajax.put("data",list);
        return ajax;
    }
    /**
